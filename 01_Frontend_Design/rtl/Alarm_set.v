...
///////indicators of the digit while changing ////////
    ...
    reg       sound_flag,sound_flag_2;

    ///// Encoding using gray code /////

    localparam           Ideal        = 3'b000;//0
    localparam           Alarm_act    = 3'b001;//1
    localparam           H2           = 3'b011;//3
    localparam           H1           = 3'b010;//2
    localparam           M2           = 3'b110;//6
    localparam           M1           = 3'b111;//7

    assign sound = ((Hd2==no_hours_2) && (Hd1==no_hours_1) && /// alarm condition 
                   (Md2==no_minute_2) && (Md1==no_minute_1) && sound_flag_2);
    ...
    always @(*) begin
            ...
            case (current_state)
                ...
                H2: begin
                    ...
                    if (En && Set && (Hd2 == 1)&& (Hd1 >3) && ~Both)begin
                        H2_n=Hd2+1;
                        H1_n=4'd0;
                        M1_n=Md1;
                        M2_n=Md2;
